...
export declare function parseCurrency(input: unknown, locale?: string, currency?: string): number | undefined;
export declare function parseCurrency(input: unknown, options?: CurrencyFormatOptions): number | undefined;
