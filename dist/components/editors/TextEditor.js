...
export default function TextEditor({ value, onChange, onCommit, onCancel, autoFocus }) {
    ...
    return (_jsx(TextField, { variant: "standard", size: "small", margin: "dense", value: typeof value === "string" ? value : value !== null && value !== void 0 ? value : "", inputRef: ref, onChange: (e) => onChange(e.target.value), onKeyDown: onKeyDown, onBlur: onBlur, autoFocus: autoFocus, fullWidth: true, sx: compactTextFieldSx }));
}
