...
export function formatCurrency(
  ...
  { locale = 'de-DE', currency = 'EUR', minimumFractionDigits = 2, maximumFractionDigits = 2 }: CurrencyFormatOptions = {}
): string {
 ...
 */
export function parseCurrency(input: unknown): number | undefined {
